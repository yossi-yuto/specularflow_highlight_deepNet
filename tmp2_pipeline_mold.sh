...
CUDA_VISIBLE_DEVICES=${DEVICE_NUM} python main.py -dataset_path data/plastic_mold_dataset -test_mold_type ${kind} -mode refine -write_dir ${write_dir}/ex_${iter} --train --eval --refine_non_minus #-read_weight_path ${read_dir}/ex_${iter}
CUDA_VISIBLE_DEVICES=${DEVICE_NUM} python main.py -dataset_path data/plastic_mold_dataset -test_mold_type ${kind} -mode pmd -write_dir ${write_dir}/ex_${iter} --train --eval --refine_non_minus #-read_weight_path ${read_dir}/ex_${iter}
